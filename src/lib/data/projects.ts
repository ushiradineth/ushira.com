...
export const projects: Project[] = [
  {
    ...
    description:
      "A lazygit-style terminal UI for Terraform with workspace-aware execution and plan-first workflows.",
    technologies: [
    ...
    links: [
      {
        label: "GitHub - lazytf",
        logo: "mdi:github",
        href: "https://github.com/ushiradineth/lazytf",
      },
    ],
  },
  {
    ...
    description:
      "An efficient code index and retrieval toolkit built for AI agents to go from prompt to implementation ASAP.",
    technologies: [
      {
        name: "TypeScript",
    ...
    links: [
      {
        label: "GitHub - veil",
        logo: "mdi:github",
        href: "https://github.com/ushiradineth/veil",
      },
    ],
  },
  {
    ...
    links: [
      {
        label: "GitHub - kei",
        logo: "mdi:github",
        href: "https://github.com/ushiradineth/kei",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    period: "July 2024 – ∞",
    description:
      "Multi host/architecture nix configuration for NixOS, MacOS, Raspberry Pi 5 and other.",
    technologies: [
  ...
  },
  {
    ...
    description:
      "Homelab with Terraform, Ansible, Docker, and Kubernetes (k3d). Superseded by Nix Config.",
    technologies: [
      {
        name: "Terraform",
        icon: "simple-icons:terraform",
