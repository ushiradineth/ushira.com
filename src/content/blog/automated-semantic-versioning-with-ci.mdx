...
image: ../../images/blog/automated-semantic-versioning-with-ci/gitflow.png
imageAlt: "GitFlow branching strategy visualised"
---
...
<FigureImage src={gitflow} alt="Diagram illustrating the GitFlow branching model" caption="Figure 1: GitFlow branching model - main branches and their relationships." />
...
<FigureImage src={mainBranchPipeline} alt="Flowchart of the main branch pipeline" caption="Figure 2: Main branch pipeline - production deployment workflow with version management." />
...
<FigureImage src={releaseBranchPipeline} alt="Flowchart of the release branch pipeline" caption="Figure 3: Release branch pipeline - release candidate versioning and deployment." />
...
<FigureImage src={developBranchPipeline} alt="Flowchart of the develop branch pipeline" caption="Figure 4: Develop branch pipeline - snapshot build workflow for active development." />
...
<FigureImage src={versionBumpPipeline} alt="Flowchart of the version-bump pipeline" caption="Figure 5: Version-bump pipeline - manual version increment workflow for major, minor, or patch updates." />
...
<FigureImage src={initiateReleaseBranchPipeline} alt="Flowchart of the initiate-release-branch pipeline" caption="Figure 6: Initiate-release-branch pipeline - automated release branch creation from develop." />
