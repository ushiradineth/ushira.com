...
description: "Automating application delivery with GitOps patterns and ArgoCD."
date: 2024-02-20
tags: ["gitops", "argocd", "terraform", "kubernetes", "cicd"]
image: ../../images/blog/gitops-with-argocd/gitops-flow.png
imageAlt: "Diagram showing GitOps workflow with ArgoCD"
---
...
<FigureImage src={gitopsFlow} alt="Diagram explaining the GitOps workflow" caption="Figure 1: GitOps workflow - declarative configuration management with Git as source of truth." />
...
<FigureImage src={reconciliationLoop} alt="Diagram of the GitOps reconciliation loop" caption="Figure 2: Reconciliation loop - continuous synchronization between desired and actual state." />
...
<FigureImage src={terraformFlow} alt="Diagram of the Terraform push-based GitOps flow" caption="Figure 3: Terraform push-based flow - automated infrastructure changes triggered by Git commits." />
...
<FigureImage src={argocdFlow} alt="Diagram of the ArgoCD pull-based GitOps flow" caption="Figure 4: ArgoCD pull-based flow - continuous monitoring and synchronization from Git to Kubernetes cluster." />
...
<FigureImage src={argocdImageUpdaterFlow} alt="Diagram of the ArgoCD Image Updater workflow" caption="Figure 5: ArgoCD Image Updater flow - automated container image updates in Kubernetes manifests." />
